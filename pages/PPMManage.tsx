      ...
      try {
        ...
        const newMarkets: Marche[] = dataRows.map((row, i) => {
          ...
          return {
            ...
            has_preselection: shouldAggregate ? (existingMarket?.has_preselection || false) : false,
            has_demande_eclaircissement: shouldAggregate ? (existingMarket?.has_demande_eclaircissement || false) : false,
            has_reponse_eclaircissement: shouldAggregate ? (existingMarket?.has_reponse_eclaircissement || false) : false,
